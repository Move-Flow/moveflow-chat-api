...
async function subscription_chat(account: string, msg: string): Promise<{ _msg: any, _status: number }> {
  ...
  (3) Once the client confirm the format, you will say: "Before we start, can we confirm the monthly service price? how about 1000 USDT per month?" 
